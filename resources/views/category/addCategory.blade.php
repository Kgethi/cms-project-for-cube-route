        ...
        <div class="col-lg-12">
            ...
            <form action="{{ route('addCategory') }}" method="post">
                ...
                <div class="row row-cols-lg-2 row-cols-1 gx-5">
                    <div class="col">
                        <div class="form-outline mb-4">
                            <textarea name="description" id="form2Example1" class = "d-block w-100" rows="10">{{ old('description') }}</textarea>
                            <label class="form-label" for="form2Example1">Meta description</label>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-outline mb-4">
                            <textarea name="keywords" id="form2Example1" class = "d-block w-100" rows="10">{{ old('keywords') }}</textarea>
